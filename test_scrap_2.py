...
#
try:
    enter_1 = brs.find_element_by_xpath('//*[@id="layui-m-layer1"]/div[2]/div/div')
    brs.refresh()
except NoSuchElementException:
    pass

s = brs.find_element_by_xpath('//*[@id="app"]/div/div[1]/div[3]/button/div/div[2]/div[1]/div/input')
s.click()
...
btn_2 = brs.find_element_by_xpath('//*[@id="layui-laydate1"]/div/div[2]/table/tbody/tr[4]/td[3]')
btn_2.click()
time.sleep(2)
